...
describe("SkillsPage local Skills lifecycle", () => {
  ...
  it("keeps the loaded count and list across a page remount without loading again", async () => {
    listSkillImportCandidates.mockResolvedValue(snapshot(skill("alpha"), skill("beta")));
